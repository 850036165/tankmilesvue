<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>留言记录</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    return {
      ...
      gridOptions: {
        ...
        proxyConfig: {
          ...
          ajax: {
            query: async ({ page, sort, filters }) => {
              ...
              // 请求数据
              const response = await this.$http.post('/system/message/list', queryParams).catch((error) => {
        ...
        columns: [
          ...
          { field: 'email', title: '联系方式', minWidth: 100, align: 'center' },
          { field: 'content', title: '留言内容', minWidth: 100, align: 'center' }
        ]
      }
    }
  },
